    ...
    <div class="timeline">
      ...
      <div class="timeline-items" role="tablist" aria-label="Các mốc lịch sử Nha Khoa Đông Nam">
        <button class="tl-item" role="tab" aria-selected="false"
          ...
          data-desc="Khởi nguồn từ mong muốn mang lại nụ cười tự tin và bền vững cho người Việt, Nha Khoa Đông Nam chính thức ra đời. Sự kiện này đặt viên gạch đầu tiên cho một thương hiệu nha khoa truyền thống và lâu đời, nơi y đức, sự tận tâm và tiêu chuẩn y khoa khắt khe được gìn giữ qua nhiều thế hệ khách hàng.">
        ...
        <button class="tl-item" role="tab" aria-selected="false"
          ...
          data-desc="Đánh dấu một bước ngoặt lớn khi vinh dự nhận giải thưởng "Dịch vụ tốt nhất năm 2015". Thực hiện thành công hơn 8.000 trụ Implant, Đông Nam chính thức được định vị là phòng khám hàng đầu trong lĩnh vực phục hình răng cho cả những ca mất răng lâu năm, tiêu xương hàm phức tạp.">
          <div class="tl-dot"></div>
        ...
        <button class="tl-item" role="tab" aria-selected="false"
          ...
          data-desc="Đáp ứng nhu cầu ngày càng lớn mạnh, Nha Khoa Đông Nam khai trương cơ sở 2 tại 614 - 616 Lê Hồng Phong. Sự vươn mình này không chỉ nâng cấp trang thiết bị, mà còn thực tế hóa lời cam kết đồng hành trọn đời với một hệ thống liền mạch, thuận tiện cho khách hàng chăm sóc định kỳ.">
          <div class="tl-dot"></div>
        ...
        <button class="tl-item" role="tab" aria-selected="false"
          ...
          data-desc="Vinh dự nhận giải thưởng "TOP 10 THƯƠNG HIỆU TIN CẬY, SẢN PHẨM CHẤT LƯỢNG, DỊCH VỤ TẬN TÂM 2019". 'Dịch vụ tận tâm' là thước đo cho kế hoạch điều trị cá nhân hóa và chính sách chăm sóc sau điều trị không giới hạn.">
          <div class="tl-dot"></div>
        ...
        <button class="tl-item" role="tab" aria-selected="false"
          ...
          data-desc="Được vinh danh tại giải thưởng danh giá 'THE BEST OF VIETNAM 2024'. Thành tựu hơn 21 năm của Đông Nam là sự hội tụ của truyền thống uy tín, đội ngũ bác sĩ chuyên môn và sự đồng hành tận tâm cùng nụ cười Việt.">
          <div class="tl-dot"></div>
  ...
  <div class="container">
    ...
    <div class="result-slider" id="sliderImplant">
      ...
      <div class="result-slides">
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/cay-1-tru-implant-rang-cua-ham-tren-phuc-hinh-rang-bi-mat.webp" alt="Kết quả cấy 1 trụ Implant răng cửa hàm trên phục hình răng bị mất" loading="lazy"></div>
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/cay-1-tru-implant-rang-ham-nhai-so-6-phuc-hinh-rang-bi-mat.webp" alt="Kết quả cấy 1 trụ Implant răng hàm nhai số 6 phục hình răng bị mất" loading="lazy"></div>
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/cay-1-tru-implant-rang-ham-nhai-phuc-hinh-rang-bi-mat.webp" alt="Kết quả cấy 1 trụ Implant răng hàm nhai phục hình răng bị mất" loading="lazy"></div>
    ...
    <div class="result-slider" id="sliderRangsu">
      ...
      <div class="result-slides">
        ...
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/boc-su-4-rang-cua-khac-phuc-rang-moc-khong-deu.webp" alt="Bọc sứ 4 răng cửa cải thiện răng mọc không đều" loading="lazy"></div>
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/boc-6-rang-su-zirconia-khac-phuc-rang-bi-thua.webp" alt="Bọc 6 răng sứ zirconia khắc phục răng thừa" loading="lazy"></div>
        <div class="result-slide"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/11/boc-2-ham-rang-toan-su-hi-zirconia-khac-phuc-tinh-trang-rang-o-vang.webp" alt="Bọc 2 hàm răng toàn sứ hi-zirconia cho răng ố vàng" loading="lazy"></div>
    ...
    <div class="testi-slider">
      ...
      <div class="testi-inner">
        <div class="testi-slides">
          <div class="testi-slide"><div class="testi-card" data-videoid="c8Pb_kKWdMM"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Co+Lan&font=playfair-display" alt="Video cảm nhận Cô Lan Q.Phú Nhuận" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Cô Lan">▶</button><div class="testi-info"><div class="name">Cô Lan · Q.Phú Nhuận</div><div class="meta">Khách hàng từ 2008</div></div></div></div>
          <div class="testi-slide"><div class="testi-card" data-videoid="eblVhYpRay8"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Chu+Hai&font=playfair-display" alt="Video cảm nhận Chú Hải Q.10" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Chú Hải">▶</button><div class="testi-info"><div class="name">Chú Hải · Q.10</div><div class="meta">Implant toàn hàm</div></div></div></div>
          <div class="testi-slide"><div class="testi-card" data-videoid="kh1zckdYSX8"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Chi+Ngoc&font=playfair-display" alt="Video cảm nhận Chị Ngọc Tân Bình" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Chị Ngọc">▶</button><div class="testi-info"><div class="name">Chị Ngọc · Tân Bình</div><div class="meta">Bọc răng sứ</div></div></div></div>
          <div class="testi-slide"><div class="testi-card" data-videoid="rQkbBt-CciA"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Anh+Minh&font=playfair-display" alt="Video cảm nhận Anh Minh Gò Vấp" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Anh Minh">▶</button><div class="testi-info"><div class="name">Anh Minh · Gò Vấp</div><div class="meta">Niềng răng trong suốt</div></div></div></div>
          <div class="testi-slide"><div class="testi-card" data-videoid="uNDrs3Cvwvs"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Chi+Thuy&font=playfair-display" alt="Video cảm nhận Chị Thùy Q.Phú Nhuận" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Chị Thùy">▶</button><div class="testi-info"><div class="name">Chị Thùy · Q.Phú Nhuận</div><div class="meta">Implant kỹ thuật số</div></div></div></div>
          <div class="testi-slide"><div class="testi-card" data-videoid="vatpzUlPl4c"><img src="https://placehold.co/480x640/1B2A4A/E8D5A8?text=Anh+Tung&font=playfair-display" alt="Video cảm nhận Anh Tùng Bình Thạnh" loading="lazy" width="480" height="640"><button class="testi-play" aria-label="Phát video cảm nhận của Anh Tùng">▶</button><div class="testi-info"><div class="name">Anh Tùng · Bình Thạnh</div><div class="meta">Phục hình toàn hàm</div></div></div></div>
        </div>
      </div>
    ...
    <div class="foot-grid">
      <div class="foot-col foot-col-brand">
        ...
        <div class="foot-address">
          <div class="foot-address-item"><span class="foot-icon">📍</span><div><strong>Cơ sở 1:</strong> 411 Nguyễn Kiệm, Phường 9, Quận Phú Nhuận, TPHCM - <a href="https://maps.google.com/maps?q=411+Nguyen+Kiem,+Phu+Nhuan,+Ho+Chi+Minh+City,+Vietnam" target="_blank" rel="noopener" class="foot-link-inline"><em>Click xem bản đồ</em></a></div></div>
          <div class="foot-address-item"><span class="foot-icon">📍</span><div><strong>Cơ sở 2:</strong> 614 Lê Hồng Phong, Phường 10, Quận 10, TPHCM - <a href="https://maps.google.com/maps?q=614+Le+Hong+Phong,+District+10,+Ho+Chi+Minh+City,+Vietnam" target="_blank" rel="noopener" class="foot-link-inline"><em>Click xem bản đồ</em></a></div></div>
        </div>
        <div class="foot-phones">
          <div class="foot-phone-item"><span class="foot-icon">📞</span><span><strong>Tư Vấn:</strong> <a href="tel:19007141" class="foot-link-inline">1900.7141</a></span></div>
          <div class="foot-phone-item"><span class="foot-icon">📞</span><span><strong>Điện thoại:</strong> <a href="tel:02873077141" class="foot-link-inline">(028).7307.7141</a></span></div>
          <div class="foot-phone-item"><span class="foot-icon">📞</span><span><strong>Hotline:</strong> <a href="tel:0972411411" class="foot-link-inline">0972.411.411</a></span></div>
        </div>
        <div class="foot-email"><span class="foot-icon">✉️</span><span><strong>Email:</strong> <a href="mailto:nhakhoadongnam@gmail.com" class="foot-link-inline">nhakhoadongnam@gmail.com</a></span></div>
        <div class="foot-working-hours"><strong>Thời gian làm việc</strong><ul><li>Thứ 2 - 7: 8h00 - 19h00</li><li>Chủ nhật: 8h00 - 16h00</li></ul></div>
      </div>
      ...
      <div class="foot-col">
        ...
        <div class="foot-social-icons">
          <a href="https://facebook.com/nhakhoadongnam" target="_blank" rel="noopener" aria-label="Facebook Nha Khoa Đông Nam"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/02/icon-facebook.png" alt="Facebook" loading="lazy"></a>
          <a href="https://youtube.com/@nhakhoadongnam" target="_blank" rel="noopener" aria-label="YouTube Nha Khoa Đông Nam"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/02/icon-youtube.png" alt="YouTube" loading="lazy"></a>
          <a href="#" target="_blank" rel="noopener" aria-label="Zalo Nha Khoa Đông Nam"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/02/icon-zalo.png" alt="Zalo" loading="lazy"></a>
          <a href="#" target="_blank" rel="noopener" aria-label="WhatsApp Nha Khoa Đông Nam"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/02/icon-whatsapp.png" alt="WhatsApp" loading="lazy"></a>
          <a href="#" target="_blank" rel="noopener" aria-label="Instagram Nha Khoa Đông Nam"><img src="https://nhakhoadongnam.com/wp-content/uploads/2024/02/icon-instagram.png" alt="Instagram" loading="lazy"></a>
        </div>
...
<!-- ═══ FLOATING CTA ═══ -->
<div class="cta-float">
  <a href="tel:0972411411" class="float-btn float-tel" aria-label="Gọi hotline 0972 411 411">📞 Gọi ngay</a>
  <a href="#cta" class="float-btn float-primary" aria-label="Đặt lịch tư vấn miễn phí">📅 Đặt lịch</a>
</div>
