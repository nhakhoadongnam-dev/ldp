...
?>
<html <?php language_attributes(); ?>><head>  <?php wp_head(); ?>
</head><body>﻿
  ...
  <div class="ndn-container">
    ...
    <div class="tl-video">
      <div class="tl-video-wrap">
        <iframe src="https://www.youtube.com/embed/BbhrSFq6jUk?rel=0" title="TVC kỷ niệm 21 năm — Nha Khoa Đông Nam" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" loading="lazy">
        </iframe>
    ...
    <div class="timeline">
      ...
      <div class="timeline-items" role="tablist" aria-label="Các mốc lịch sử Nha Khoa Đông Nam">
        <button class="tl-item" role="tab" aria-selected="false" data-year="2005" data-title="Nha Khoa Đông Nam thành lập" data-desc="Khởi nguồn từ mong muốn mang lại nụ cười tự tin và bền vững cho người Việt, Nha Khoa Đông Nam chính thức ra đời. Sự kiện này đặt viên gạch đầu tiên cho một thương hiệu nha khoa truyền thống và lâu đời, nơi y đức, sự tận tâm và tiêu chuẩn y khoa khắt khe được gìn giữ qua nhiều thế hệ khách hàng.">
          <div class="tl-dot"></div>
          <div class="tl-year">2005</div>
          <div class="tl-label">Nha Khoa Đông Nam thành lập</div>
        </button>
        <button class="tl-item" role="tab" aria-selected="false" data-year="2015" data-title="Xác lập vị thế chuyên gia Implant" data-desc="Đánh dấu một bước ngoặt lớn khi vinh dự nhận giải thưởng “Dịch vụ tốt nhất năm 2015”. Thực hiện thành công hơn 8.000 trụ Implant, Đông Nam chính thức được định vị là phòng khám hàng đầu trong lĩnh vực phục hình răng cho cả những ca mất răng lâu năm, tiêu xương hàm phức tạp.">
          <div class="tl-dot"></div>
          <div class="tl-year">2015</div>
          <div class="tl-label">Xác lập vị thế chuyên gia Implant</div>
        </button>
        <button class="tl-item" role="tab" aria-selected="false" data-year="2017" data-title="Nối dài cam kết Đồng hành trọn đời" data-desc="Đáp ứng nhu cầu ngày càng lớn mạnh, Nha Khoa Đông Nam khai trương cơ sở 2 tại 614 - 616 Lê Hồng Phong. Sự vươn mình này không chỉ nâng cấp trang thiết bị, mà còn thực tế hóa lời cam kết đồng hành trọn đời với một hệ thống liền mạch, thuận tiện cho khách hàng chăm sóc định kỳ.">
          <div class="tl-dot"></div>
          <div class="tl-year">2017</div>
          <div class="tl-label">Nối dài cam kết Đồng hành trọn đời</div>
        </button>
        <button class="tl-item" role="tab" aria-selected="false" data-year="2019" data-title="Bảo chứng cho sự chăm sóc tận tâm" data-desc="Vinh dự nhận giải thưởng “TOP 10 THƯƠNG HIỆU TIN CẬY, SẢN PHẨM CHẤT LƯỢNG, DỊCH VỤ TẬN TÂM 2019”. 'Dịch vụ tận tâm' là thước đo cho kế hoạch điều trị cá nhân hóa và chính sách chăm sóc sau điều trị không giới hạn.">
          <div class="tl-dot"></div>
          <div class="tl-year">2019</div>
          <div class="tl-label">Bảo chứng cho sự chăm sóc tận tâm</div>
        </button>
        <button class="tl-item" role="tab" aria-selected="false" data-year="2024" data-title="Top 10 Nha Khoa Tốt Nhất Việt Nam" data-desc="Được vinh danh tại giải thưởng danh giá 'THE BEST OF VIETNAM 2024'. Thành tựu hơn 21 năm của Đông Nam là sự hội tụ của truyền thống uy tín, đội ngũ bác sĩ chuyên môn và sự đồng hành tận tâm cùng nụ cười Việt.">
          <div class="tl-dot"></div>
