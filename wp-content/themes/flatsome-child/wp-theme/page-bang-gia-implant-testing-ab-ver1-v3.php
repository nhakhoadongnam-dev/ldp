<?php
/**
 * Template Name: Bảng Giá Implant Testing AB ver1 Landing v3
  ...
  <div class="ndn-container">
    ...
    <div class="price-notice-box">
      ...
      <div class="pnb-grid">
        ...
        <div class="pnb-item"><div class="pnb-check"><svg viewBox="0 0 12 12" fill="white"><path d="M2 6l3 3 5-5" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"></path></svg></div><span>Đồng hành trọn đời cùng Khách hàng</span></div>
      </div>
    </div>
    ...
    <div class="reco-list" style="margin-bottom:16px;">
      <div class="reco-card">
        ...
        <div class="reco-body">
          <div class="reco-name"><span class="lp-flag lp-flag-it" aria-label="Y" role="img"><svg viewBox="0 0 36 24" aria-hidden="true"><rect width="12" height="24" fill="#009246"></rect><rect x="12" width="12" height="24" fill="#fff"></rect><rect x="24" width="12" height="24" fill="#ce2b37"></rect></svg></span> Implant Ý — C-Tech</div>
      ...
      <div class="reco-card">
        ...
        <div class="reco-body">
          <div class="reco-name"><span class="lp-flag lp-flag-kr" aria-label="Han Quoc" role="img"><svg viewBox="0 0 36 24" aria-hidden="true"><rect width="36" height="24" fill="#fff"></rect><circle cx="18" cy="12" r="5.2" fill="#c60c30"></circle><path d="M18 6.8a5.2 5.2 0 0 1 0 10.4a5.2 5.2 0 0 0 0-10.4z" fill="#003478"></path><path d="M7 5l5 2M8 3l5 2M6 7l5 2M24 17l5 2M25 15l5 2M23 19l5 2M25 5l5-2M24 7l5-2M23 9l5-2M7 19l5-2M8 21l5-2M6 17l5-2" stroke="#111" stroke-width="1.1"></path></svg></span> Implant Hàn Quốc</div>
          <div style="margin:4px 0 8px;display:flex;gap:6px;flex-wrap:wrap;">
      ...
      <div class="reco-card">
        ...
        <div class="reco-body">
          <div class="reco-name"><span class="lp-flag lp-flag-fr" aria-label="Phap" role="img"><svg viewBox="0 0 36 24" aria-hidden="true"><rect width="12" height="24" fill="#002395"></rect><rect x="12" width="12" height="24" fill="#fff"></rect><rect x="24" width="12" height="24" fill="#ed2939"></rect></svg></span> Pháp (ETK Active) / <span class="lp-flag lp-flag-se" aria-label="Thuy Dien" role="img"><svg viewBox="0 0 36 24" aria-hidden="true"><rect width="36" height="24" fill="#006aa7"></rect><rect x="10" width="4" height="24" fill="#fecc00"></rect><rect y="10" width="36" height="4" fill="#fecc00"></rect></svg></span> Thụy Điển (Nobel Active)</div>
          <div style="margin:4px 0 8px;display:flex;gap:6px;flex-wrap:wrap;">
  ...
  <div class="ndn-container">
    ...
    <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.4);border:2px solid rgba(201,168,76,0.3);">
      ...
      <div id="qz-nav2" style="display:flex;justify-content:space-between;align-items:center;padding:14px 20px;border-top:1px solid var(--gray);background:var(--off-white);">
        <button id="qz-prev2" onclick="qzPrev2()" style="display:none;font-size:12px;font-weight:800;color:var(--text-sub);background:none;border:none;cursor:pointer;font-family:var(--font-body);text-transform:uppercase;padding:8px 12px;">← Quay lại</button>
        ...
        <button id="qz-next2" onclick="qzNext2()" disabled="" style="background:var(--navy);color:#fff;font-family:var(--font-body);font-weight:800;font-size:12px;text-transform:uppercase;padding:12px 22px;border-radius:10px;border:none;cursor:pointer;opacity:0.3;transition:opacity .2s;letter-spacing:0.5px;">Tiếp theo</button>
      </div>
    </div>
  </div>
</section>
