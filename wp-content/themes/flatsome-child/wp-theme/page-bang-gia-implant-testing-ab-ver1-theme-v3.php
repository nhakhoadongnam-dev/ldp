  ...
  <div class="ndn-container">
    ...
    <div class="price-notice-box">
      ...
      <div class="pnb-grid">
        ...
        <div class="pnb-item"><div class="pnb-check"><svg viewBox="0 0 12 12" fill="white"><path d="M2 6l3 3 5-5" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/></svg></div><span>Khớp nối Abutment (trị giá 5.000.000đ)</span></div>
