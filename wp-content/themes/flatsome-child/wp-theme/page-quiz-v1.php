<?php
/**
 * Template Name: Dự Toán Implant Landing v1
...
<!DOCTYPE html><html <?php language_attributes(); ?>><head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Be+Vietnam+Pro:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flag-icons@7.2.3/css/flag-icons.min.css">
  <link rel="stylesheet" href="<?php echo esc_url($lp_base); ?>/Quiz.css">
</head>
<body>
<div class="ndn-lp">
...
<script src="<?php echo esc_url($lp_base); ?>/Quiz.js"></script>
<?php wp_footer(); ?>
</body>
</html>
