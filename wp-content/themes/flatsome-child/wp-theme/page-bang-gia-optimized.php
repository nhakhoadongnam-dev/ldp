<?php
/**
 * Template Name: Bảng Giá Landing (Optimized)
 *
 * Standalone landing page — không dùng header/footer của theme.
 * CSS/JS load trực tiếp từ /page/bang-gia/ (không cần copy assets).
 *
 * OPTIMIZED VERSION:
 * - Xóa GTM/GA4 hardcode → Để Google Site Kit inject
 * - Xóa SEO meta tags → Để Yoast SEO inject
 * - GIỮ Schema.org JSON-LD (chi tiết hơn Yoast)
 * - GIỮ custom header/footer của landing page
 *
 * Cách dùng:
 * 1. WP Admin → Pages → Add New → chọn template "Bảng Giá Landing (Optimized)".
...
<main class="ndn-page" id="ndn-main">
  ...
  <section class="ndn-section" id="nieng">
    ...
    <table class="price-table price-table--unit-align">
      ...
      <tbody>
        <tr><td class="svc-name">Niền mắc cài tự buộc</td><td class="svc-unit">2 hàm</td><td class="price-col"><span class="price-val">50.000.000 ₫</span></td><td class="price-col"></td></tr>
        <tr><td class="svc-name">Niền mắc cài sứ</td><td class="svc-unit">2 hàm</td><td class="price-col"><span class="price-val">55.000.000 ₫</span></td><td class="price-col"></td></tr>
        <tr><td class="svc-name">Niền mắc cài cánh cam</td><td class="svc-unit">2 hàm</td><td class="price-col"><span class="price-val">65.000.000 ₫</span></td><td class="price-col"></td></tr>
        <tr><td><span class="svc-name">Niền răng trong suốt <span class="badge-aesthetic-green">Thẩm mỹ</span></span></td><td class="svc-unit">2 hàm</td><td class="price-col"><span class="price-val">130.000.000 ₫</span></td><td class="price-col"></td></tr>
